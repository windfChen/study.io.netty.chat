package com.windf.study.io.netty.chat.client;

import com.windf.study.io.netty.chat.client.handler.ChatClientHandler;
...
public class ChatClient {
    ...
    public static void main(String[] args){
        new ChatClient("cyf").connect("127.0.0.1",80);
    }
}
